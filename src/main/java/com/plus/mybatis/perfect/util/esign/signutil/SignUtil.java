package com.plus.mybatis.perfect.util.esign.signutil;
...
public class SignUtil {
    ...
    public static void sign(InputStream src  //需要签章的pdf文件路径
        ...
        appearance.setVisibleSignature(new Rectangle(200, 200, 20, 20), pageCount, "孙李娅");
    ...
    public static void main(String[] args) throws  Exception {
        String KEYSTORE="d:/signkey/houKeyStore";
        char[] PASSWORD = "rootcert".toCharArray();//keystory密码
        String SRC="d:/个人成长规划报告.pdf" ;//原始pdf
        String DEST="d://pcs12//demo_signed_box.pdf" ;//签名完成的pdf
        String DEST2="d:/signkey/"+System.currentTimeMillis()+".pdf" ;//签名完成的pdf
        String chapterPath="d:/signkey/sign.jpg";//签章图片
        String reason="数据不可更改";
        String location="孙李娅";

        sign(new FileInputStream(SRC), new FileOutputStream(DEST2),
